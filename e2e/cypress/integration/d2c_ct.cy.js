describe('brerules',()=>{
    it('test1',()=>{
        cy.visit('https://stage_bajajloan.cartradeexchange.com/d2c_listing/CT')
        cy.get(':nth-child(4) > #pulsar-tab').click({force:true})
        ...
        cy.get(':nth-child(3) > .me-5 > .form-control').type('50000')
