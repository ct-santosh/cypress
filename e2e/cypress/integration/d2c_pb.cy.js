describe('brerules',()=>{
    it('test1',()=>{
        cy.visit('https://stage_bajajloan.cartradeexchange.com/d2c_listing/PB')
        cy.get('.listing-blk').click({force:true})
        cy.wait(2000)
        ...
        cy.get(':nth-child(2) > .card-body > .d-voucher > .btn').click({force:true})
